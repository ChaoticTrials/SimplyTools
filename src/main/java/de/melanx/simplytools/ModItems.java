...
public class ModItems {
    ...
    public static final Item copperHammer = ModItems.makeItem(List.of(CompatHelper.COPPERIZED, CompatHelper.MOREVANILLATOOLS), 0, -3.0f, ToolMaterials.COPPER, BlockTags.MINEABLE_WITH_PICKAXE, new Item.Properties());
    ...
    public static final Item copperExcavator = ModItems.makeItem(List.of(CompatHelper.COPPERIZED, CompatHelper.MOREVANILLATOOLS), 0, -3.2f, ToolMaterials.COPPER, BlockTags.MINEABLE_WITH_SHOVEL, new Item.Properties());
