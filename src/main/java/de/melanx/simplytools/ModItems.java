...
public class ModItems {
    ...
    public static final Item glowstoneHammer = ModItems.makeItem(CompatHelper.MOREVANILLATOOLS, 0, -3.0f, ToolMaterials.GLOWSTONE, BlockTags.MINEABLE_WITH_PICKAXE, new Item.Properties().tab(SimplyTools.getTab()));
    public static final Item lapisHammer = ModItems.makeItem(CompatHelper.MOREVANILLATOOLS, 0, -3.0f, ToolMaterials.LAPIS, BlockTags.MINEABLE_WITH_PICKAXE, new Item.Properties().tab(SimplyTools.getTab()));
    public static final Item netherHammer = ModItems.makeItem(CompatHelper.MOREVANILLATOOLS, 0, -3.0f, ToolMaterials.NETHER, BlockTags.MINEABLE_WITH_PICKAXE, new Item.Properties().tab(SimplyTools.getTab()));
    public static final Item obsidianHammer = ModItems.makeItem(CompatHelper.MOREVANILLATOOLS, 0, -3.2f, ToolMaterials.OBSIDIAN, BlockTags.MINEABLE_WITH_PICKAXE, new Item.Properties().tab(SimplyTools.getTab()));
    public static final Item paperHammer = ModItems.makeItem(CompatHelper.MOREVANILLATOOLS, 0, -3.0f, ToolMaterials.PAPER, BlockTags.MINEABLE_WITH_PICKAXE, new Item.Properties().tab(SimplyTools.getTab()));
    public static final Item prismarineHammer = ModItems.makeItem(CompatHelper.MOREVANILLATOOLS, 0, -3.0f, ToolMaterials.PRISMARINE, BlockTags.MINEABLE_WITH_PICKAXE, new Item.Properties().tab(SimplyTools.getTab()));
    public static final Item quartzHammer = ModItems.makeItem(CompatHelper.MOREVANILLATOOLS, 0, -3.0f, ToolMaterials.QUARTZ, BlockTags.MINEABLE_WITH_PICKAXE, new Item.Properties().tab(SimplyTools.getTab()));
    public static final Item redstoneHammer = ModItems.makeItem(CompatHelper.MOREVANILLATOOLS, 0, -3.0f, ToolMaterials.REDSTONE, BlockTags.MINEABLE_WITH_PICKAXE, new Item.Properties().tab(SimplyTools.getTab()));
    public static final Item slimeHammer = ModItems.makeItem(CompatHelper.MOREVANILLATOOLS, 0, -3.0f, ToolMaterials.SLIME, BlockTags.MINEABLE_WITH_PICKAXE, new Item.Properties().tab(SimplyTools.getTab()));

    public static final Item enderiteHammer = ModItems.makeItem(CompatHelper.ENDERITE, 0, -3.0f, ToolMaterials.ENDERITE, BlockTags.MINEABLE_WITH_PICKAXE, new Item.Properties().tab(SimplyTools.getTab()));
    ...
    public static final Item glowstoneExcavator = ModItems.makeItem(CompatHelper.MOREVANILLATOOLS, 0, -3.2f, ToolMaterials.GLOWSTONE, BlockTags.MINEABLE_WITH_SHOVEL, new Item.Properties().tab(SimplyTools.getTab()));
    public static final Item lapisExcavator = ModItems.makeItem(CompatHelper.MOREVANILLATOOLS, 0, -3.2f, ToolMaterials.LAPIS, BlockTags.MINEABLE_WITH_SHOVEL, new Item.Properties().tab(SimplyTools.getTab()));
    public static final Item netherExcavator = ModItems.makeItem(CompatHelper.MOREVANILLATOOLS, 0, -3.2f, ToolMaterials.NETHER, BlockTags.MINEABLE_WITH_SHOVEL, new Item.Properties().tab(SimplyTools.getTab()));
    public static final Item obsidianExcavator = ModItems.makeItem(CompatHelper.MOREVANILLATOOLS, 0, -3.4f, ToolMaterials.OBSIDIAN, BlockTags.MINEABLE_WITH_SHOVEL, new Item.Properties().tab(SimplyTools.getTab()));
    public static final Item paperExcavator = ModItems.makeItem(CompatHelper.MOREVANILLATOOLS, 0, -3.2f, ToolMaterials.PAPER, BlockTags.MINEABLE_WITH_SHOVEL, new Item.Properties().tab(SimplyTools.getTab()));
    public static final Item prismarineExcavator = ModItems.makeItem(CompatHelper.MOREVANILLATOOLS, 0, -3.2f, ToolMaterials.PRISMARINE, BlockTags.MINEABLE_WITH_SHOVEL, new Item.Properties().tab(SimplyTools.getTab()));
    public static final Item quartzExcavator = ModItems.makeItem(CompatHelper.MOREVANILLATOOLS, 0, -3.2f, ToolMaterials.QUARTZ, BlockTags.MINEABLE_WITH_SHOVEL, new Item.Properties().tab(SimplyTools.getTab()));
    public static final Item redstoneExcavator = ModItems.makeItem(CompatHelper.MOREVANILLATOOLS, 0, -3.2f, ToolMaterials.REDSTONE, BlockTags.MINEABLE_WITH_SHOVEL, new Item.Properties().tab(SimplyTools.getTab()));
    public static final Item slimeExcavator = ModItems.makeItem(CompatHelper.MOREVANILLATOOLS, 0, -3.2f, ToolMaterials.SLIME, BlockTags.MINEABLE_WITH_SHOVEL, new Item.Properties().tab(SimplyTools.getTab()));

    public static final Item enderiteExcavator = ModItems.makeItem(CompatHelper.ENDERITE, 0, -3.2f, ToolMaterials.ENDERITE, BlockTags.MINEABLE_WITH_SHOVEL, new Item.Properties().tab(SimplyTools.getTab()));
    // additions
